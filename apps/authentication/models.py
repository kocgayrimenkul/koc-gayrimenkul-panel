...
class CustomUser(AbstractUser):
    ...
    phone_number = models.CharField(_('telefon numarası'), max_length=20, blank=True, null=True)
    ...
    profile_photo = models.ImageField(_('profil fotoğrafı'), upload_to='profile_photos/', blank=True, null=True)
...
class UserRole(models.Model):
    ...
    is_default = models.BooleanField(default=False, verbose_name=_('Varsayılan Rol'))
    priority = models.IntegerField(default=0, verbose_name=_('Öncelik (Yüksek değer daha önemli)'))
